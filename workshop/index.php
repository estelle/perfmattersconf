...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <hgroup class="container-large">
        ...
        <div class="headerblurb">
          <h1>Workshop: Getting Up To Speed</h1>
          <p>Monday, April 1, 2019, we're offering a full day workshop to "Get You Up To Speed" on Web Performance. Participants will learn everything they need to know to get the most out of #PerfMatters Conference. Here's what we're planning:</p>
        </div>
      </hgroup>
    </header>
    ...
    <main>
      ...
      <section>
        <div class="container-small">
          <h2 style="text-align: left;"><img src="../avatars/tim.jpg" alt="Tim Kadlec" class="tim" style="margin: 0 0 1.5rem 1rem">About Tim Kadlec</h2>
