    ...
    <header>
      <hgroup class="container-large">
        ...
        <div class="headerblurb">
          <h1>#PerfMatters 2019 Partner Kit</h1>
          <p>#PerfMatters Conference is a two-day, single-track conference devoted to front-end web performance</p>
    ...
    <main>
      ...
      <section>
        <div class="container-small">
          ...
          <p>We are grateful for any support we receive. It is because of sponsors like you that we are able to make #PerfMatters Conference happen! All sponsors, regardless of the size of contribution, get:</p>

          <ul>
            <li>Your logo on our Web site, intermission slides, and printed materials,</li>
            <li>Tweets of appreciation from our event-related twitter accounts, retweeted as appropriate from our own Twitter handle (@perfmattersconf) as well as @estellevw (9,600 followers), @standardista (11,700 followers), @webdevtips(1,100 followers), and @SFWebPerf, and</li>
        ...
        <div class="container-large">
          <article  class="reg">
            <table id="levels">
              ...
              <tr>
                <td><details><summary>Logo Promo</summary><p>All sponsorship levels include having, at minimum, your logo present on the website and a newsletter or email blast</p></details></td>
                <td>✔</td>
                <td>✔</td>
                <td>✔</td>
                <td>✔</td>
              ...
              <tr>
                <td><details><summary>Gift Bag</summary><p>all sponsorship levels can include an item in the gift bag. Size of item depends on sponsorship level.</p></details></td>
                <td><details><summary>Limited</summary><p style="width:200%">Gift item should be small and useful, like a sticker, pen, or key chain.</p></details></td>
                <td>✔</td>
                <td>✔</td>
                <td>✔</td>
              </tr>
              ...
              <tr>
                <td><details><summary>Teach Me Something</summary><p>Between talks there will be 2 to 5-minute tutorial relevant to the majority of the participants. Platinum sponsorship includes one of these sessions, topic/speaker subject to approval. </p></details></td>
                <td></td>
                <td></td>
                <td></td>
                <td>✔</td>
              ...
              <tr>
                <td><details><summary>Registration Option</summary><p>One platinum level sponsor can staff the registration desk, providing the opportunity to interact with all attendees. This is also the only "booth" in the main theatre venue.</p></details></td>
                <td></td>
                <td></td>
                <td></td>
                <td>✔ **</td>
        ...
        <div class="container-small" style="margin-top: 1.5rem;">
      ...
      <section>
        <div class="container-small">
          ...
          <ul>
            ...
            <li><a href="https://www.google.com/search?q=jem+young">Jem Young</a>, Netflix</li>
          ...
          <p>With a semi-blind* proposal reviewal process, we ended up with several surprises as we turned down talks from more famous developers in selecting what we think is a great, diverse (both topic and presenter-wise) line up. Submissions last year included (ask for the full list):</p>
          <ul class="lists">
