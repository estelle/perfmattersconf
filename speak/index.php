    ...
    <main>
      <section class="about">
        <div class="container-small">
          ...
          <ul>
            <li><img src="../photos/hat_jem_medium.jpg" alt="Jem Young sporting a rainbow mohawk balloon head piece" style="float: right; transform: rotate(10deg); width: 12rem; margin: 0 0 1.5rem 1rem; box-shadow: 3px 3px 0 3px rgba(0,0,0,0.2)" />Performance testing, metrics, work arounds &amp; discoveries</li>
      ...
      <section class="">
        <div class="container-small">
          ...
          <ul>
            <li>
              <p><strong>Travel to <acronym title="San Francisco International airport">SFO</acronym> (or <acronym title="San Jose Pineta airport">SJC</acronym>) covered.</strong> We will pay for your economy plane ticket or CalTrain ticket, up to $500 within North America, $1,100 internationally. We'll even book your itinerary if you want.</p>
            </li>

            <li>
              <p><strong>Entrance to the conference.</strong> If you get selected to speak after you've already purchased your ticket, don't worry. We can either reimburse you or give the ticket to someone who otherwise couldn't afford to attend. We'll even give you an extra ticket for a partner or friend. That way you'll know you have an extra person rooting for you.</p>
            </li>

            <li>
              <p><strong>Hotel</strong> If you're coming from outside of the greater <acronym title="san Francisco">SF</acronym> Bay area, we'll cover 2-nights hotel. If you're coming from very far away, you get 3 nights. More than 12 hour flight, and need 4 nights? Let us know, we can arrange things, just let us know. </p>
              <p>If your employer can cover your travel and hotel, we are happy to list them as a company sponsor. If you're willing to stay with a friend, AirBnB, or other speaker to help defray costs, money saved will be put back into the conference and toward scholarships.</p>
            </li>

            <li>
              <p><strong>Speaker Dinner</strong> There will be a speaker dinner the evening prior to the event. We won't keep you out too late, but we promise it will be fun and delicious.</p>

              <figure>
  	            <img src="../photos/speakers1.jpg" alt="group photo of all the speakers at the 2018 speaker dinner" style="width: 100%">

                <figcaption>Want to be in this photo? <a href="<?php echo $form ?>">Apply to speak</a> for your opportunity.</figcaption>
              </figure>
            </li>

            <li>
              <p><strong>Partners welcome</strong> If you want to bring a significant other, they are more than welcome, and are welcome to the speaker dinner and, as noted above, to the conference. </p>
            </li>

            <li>
              <p><strong>Childcare</strong> If you need child-care please let us know well in advance so we can get it all sorted out. We'll find a child sitter for the speaker dinner, and provide chilcare for brief periods during the event or a stipend to offset a babysitter for the whole event if there is a need. (We aren't licensed, and can't provide childcare at the venue for the entire event, but can bring in a babysitter during your talk so your +1 can attend your session, or provide assistance to get a babysitter elsewhere for longer periods of time.)</p>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section class="">
        <div class="container-small" style="text-align: center">
          <p><a href="<?php echo $form ?>" aria-label="Apply to speak now" class="button">Apply Now</a></p>
        </div>
      </section>
    </main>
