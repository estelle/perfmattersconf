...
foreach ($people as $name) {
	...
	?><li>
	<figure><a href="talks/#<?php echo $name ?>"><img data-src="avatars/<?php echo $name ?>.jpg" style="background-color: white" alt="<?php echo $person->fullname ?>"></a>	<figcaption><span class="name"><?php echo $person->fullname ?></span><span class="bio">
